...
namespace Console_RPG
{
    internal class Ending : LocationFeature
    {
        ...
        {
            Location.exit.SetNearbyLocations(north: null, south: null, east: null, west: null); 
            ...
            Thread.Sleep(3000);
            Console.WriteLine("Knowing there is nothing else for you to do, you move towards what you saw.\n");
            Thread.Sleep(3000);
