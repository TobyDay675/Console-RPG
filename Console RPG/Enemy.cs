...
namespace Console_RPG
{
    class Enemy : Entity
    {
        ...
        public static NormalEnemy bubbleBehemoth = new NormalEnemy("Bubble Behemoth", hp: 5000, mana: 10, new Stats(strength: 30, defense: 5, hp: 5000, mana: 10), doorknobDropCount: 250, expDropCount: 500);
        ...
        public static NormalEnemy theDirtyBubble = new NormalEnemy("The Dirty Bubble", hp: 500, mana: 10, new Stats(strength: 18, defense: 0, hp: 500, mana: 10), doorknobDropCount: 50, expDropCount: 200);
        public static NormalEnemy bubbleGladiatorA = new NormalEnemy("Bubble Gladiator", hp: 150, mana: 10, new Stats(strength: 15, defense: 0, hp: 150, mana: 10), doorknobDropCount: 50, expDropCount: 150);
        public static NormalEnemy bubbleGladiatorB = new NormalEnemy("Bubble Gladiator", hp: 150, mana: 10, new Stats(strength: 15, defense: 0, hp: 150, mana: 10), doorknobDropCount: 50, expDropCount: 150);
        public static NormalEnemy bubbleGladiatorC = new NormalEnemy("Bubble Gladiator", hp: 150, mana: 10, new Stats(strength: 15, defense: 0, hp: 150, mana: 10), doorknobDropCount: 50, expDropCount: 150);
        public static NormalEnemy bubbleGladiatorD = new NormalEnemy("Bubble Gladiator", hp: 150, mana: 10, new Stats(strength: 15, defense: 0, hp: 150, mana: 10), doorknobDropCount: 50, expDropCount: 150);
        public static NormalEnemy armoredBubbleA = new NormalEnemy("Armored Bubble", hp: 150, mana: 10, new Stats(strength: 8, defense: 5, hp: 150, mana: 10), doorknobDropCount: 25, expDropCount: 100);
        public static NormalEnemy armoredBubbleB = new NormalEnemy("Armored Bubble", hp: 150, mana: 10, new Stats(strength: 8, defense: 5, hp: 150, mana: 10), doorknobDropCount: 25, expDropCount: 100);
        public static NormalEnemy armoredBubbleC = new NormalEnemy("Armored Bubble", hp: 150, mana: 10, new Stats(strength: 8, defense: 5, hp: 150, mana: 10), doorknobDropCount: 25, expDropCount: 100);
        public static NormalEnemy armoredBubbleD = new NormalEnemy("Armored Bubble", hp: 150, mana: 10, new Stats(strength: 8, defense: 5, hp: 150, mana: 10), doorknobDropCount: 25, expDropCount: 100);
        public static NormalEnemy armoredBubbleE = new NormalEnemy("Armored Bubble", hp: 150, mana: 10, new Stats(strength: 8, defense: 5, hp: 150, mana: 10), doorknobDropCount: 25, expDropCount: 100);
