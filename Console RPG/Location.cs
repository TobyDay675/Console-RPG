...
namespace Console_RPG
{
    class Location
    {
        ...
        public static Location randomRoom1 = new Location("Yellow Door", "Sunflowerrs.\n", new Battle(new List<Enemy>() { NormalEnemy.scytheWelderA, NormalEnemy.scytheWelderB, NormalEnemy.doorScout }), true);
        public static Location randomRoom2 = new Location("Pink Door", "Hearts and Valentines blehhhhh.\n", new Battle(new List<Enemy>() { NormalEnemy.bigSpidurA, NormalEnemy.demagargenA }), true);
        public static Location randomRoom3 = new Location("Black Door", "It's pitch black in here!!\n", new Battle(new List<Enemy>() { NormalEnemy.sentientPickA, NormalEnemy.rocksA }), true);
        public static Location randomRoom4 = new Location("Orange Door", "Orange you glad it wasn't the banana door.\n", new Battle(new List<Enemy>() { MagicEnemy.cavernMasterA, NormalEnemy.lostBoy }), true);
        public static Location randomRoom5 = new Location("Banana Door", "This is crazy.\n", new Battle(new List<Enemy>() { NormalEnemy.starNosedPoleA, NormalEnemy.starNosedPoleB, NormalEnemy.starNosedPoleC }), true);
        public static Location spiderRoom = new Location("Web Door", "AHHH SPIDER!!!!!\n", new Battle(new List<Enemy>() { NormalEnemy.itsyBitsySpiderA }), true);
        public static Location spiderRoom2 = new Location("Glass Door", "Ok though they are kind of cute.\n", new Battle(new List<Enemy>() { NormalEnemy.itsyBitsySpiderB, NormalEnemy.bigSpidurB }), true);
        ...
        public static Location chickenRewardRoom = new Location("Chicken Treasure Room", "Bawk Bawk.\n", new TreasureRoom(new List<Item>() { }, new List<Equipment>() { SpecialWeapon.lightingGavel, Armor.chickenSuit}));
        public static Location mimicRoom1 = new Location("Wooden Door", "I thought it was a normal chest.\n", new Battle(new List<Enemy>() { NormalEnemy.mimicA }), true);
        public static Location mimicRoom2 = new Location("Steel Door", "The more the merrier I guess.\n", new Battle(new List<Enemy>() { NormalEnemy.mimicB, NormalEnemy.mimicC, NormalEnemy.mimicD }), true);
        public static Location mimicRoom3 = new Location("Coal Door", "How does a chest mine?\n", new Battle(new List<Enemy>() { NormalEnemy.mimicMinerA, NormalEnemy.mimicMinerB }), true);
        public static Location mimicRoom4 = new Location("Gold Door", "SO MUCH MONEYYY!!! \n", new Battle(new List<Enemy>() { NormalEnemy.mimicMinerC, NormalEnemy.mimicMinerD, NormalEnemy.mimicE, NormalEnemy.mimicF, NormalEnemy.mimicG }), true);
        public static Location spookyRoom1 = new Location("Ghost Door", "I'm shivering in my timbers.\n", new Battle(new List<Enemy>() { MagicEnemy.bubbleGhostA, NormalEnemy.skelebatonA }), true);
        ...
        public static Location spookyRoom3 = new Location("Blood Door", "How does one weld with a scythe?\n", new Battle(new List<Enemy>() { NormalEnemy.scytheWelderC, NormalEnemy.skelebatonD, NormalEnemy.skelebatonE }), true);
        public static Location mineRoom1 = new Location("Ore Door", "Mininnnng awaaaay.\n", new Battle(new List<Enemy>() { NormalEnemy.minerA, NormalEnemy.minerB }), true);
        ...
        public static Location sockPuppetLootRoom = new Location("Behind The Curtain", "Oooooooo a free sock puppet.\n", new TreasureRoom(new List<Item>() { }, new List<Equipment>() {SpecialWeapon.sockPuppet}));
        public static Location wizardShop = new Location("Purple Door", "This is one magical place.\n", new Shop("Wiz the Wizard's Emporium", new List<Item>() {HealthPotionItem.masterHealthPotion, ManaPotionItem.masterManaPotion}, new List<Equipment>() {MeleeWeapon.pickaxe, MeleeWeapon.scytheWelder, RangedWeapon.pickaxeGun, ManaWeapon.plasticWand, ManaWeapon.ancientStaff}));
        ...
        public static Location arenaLootRoom = new Location("Arena Loot Room", "You now own all of the champions assets.\n");
