...
namespace Console_RPG
{
    class MeleeWeapon : Weapon
    {
        ...
        public static MeleeWeapon pickaxe = new MeleeWeapon("Pickaxe", "Not to be confused with the sentient pick", shopPrice: 2000, sellPrice: 500, maxAmount: 1, damage: 2500);
        public static MeleeWeapon scytheWelder = new MeleeWeapon("Combination Scythe & Welding Tool", "For your farming and welding needs", shopPrice: 3000, sellPrice: 1000, maxAmount: 1, damage: 3000);
